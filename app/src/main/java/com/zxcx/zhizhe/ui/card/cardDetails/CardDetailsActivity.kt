...
//        }
    ...
    private fun gotoImageShare(bean: CardBean) {
        mDisposable = Flowable.just(fl_card_details)
                ...
                .subscribeWith(object : DisposableSubscriber<String>() {
                    ...
                    override fun onNext(s: String) {
                        ...
                        bundle.putString("card_title", bean.name)
                        bundle.putString("card_url", getString(R.string.base_url) + getString(R.string.card_share_url2) + bean.id.toString())
