 ...
 */
class LikeCardsAdapter(data : List<LikeCardsBean>) : BaseQuickAdapter<LikeCardsBean, BaseViewHolder>(R.layout.item_search_result_card,data){

    var mKeyword = ""

    override fun convert(helper: BaseViewHolder, item: LikeCardsBean) {
