...
public class HotCardAdapter extends BaseQuickAdapter<HotCardBean,BaseViewHolder> {
    ...
    protected void convert(BaseViewHolder helper, HotCardBean item) {
        ...
        para.height = (screenWidth - ScreenUtils.dip2px(20 * 2)) / 2 * 9/16;
        ...
        helper.setText(R.id.tv_item_home_card_info,mContext.getString(R.string.tv_item_home_card_num,item.getCollectNum(),item.getLikeNum()));
