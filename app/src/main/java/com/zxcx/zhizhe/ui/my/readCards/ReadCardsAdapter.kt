 ...
 */
class ReadCardsAdapter(data : List<ReadCardsBean>) : BaseQuickAdapter<ReadCardsBean, BaseViewHolder>(R.layout.item_my_card,data){
    ...
    override fun convert(helper: BaseViewHolder, item: ReadCardsBean) {
        ...
        helper.setText(R.id.tv_item_card_card_bag, if (item.subjectName.isNullOrEmpty()) item.cardBagName else item.subjectName)
