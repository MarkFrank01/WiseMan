...
import kotlinx.android.synthetic.main.dialog_share_card_note.*
...
class ShareCardNoteDialog : BaseDialog() {
	...
	override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
		...
		return inflater.inflate(R.layout.dialog_share_card_note, container)
	}
	...
	private fun initView() {
		...
		tv_dialog_share_info.text = getString(R.string.tv_item_card_note_info, date, "摘录")

		ImageLoader.load(activity, imageUrl, iv_dialog_share)
