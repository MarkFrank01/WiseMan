...
class LoginModel(present: LoginContract.Presenter) : BaseModel<LoginContract.Presenter>() {
	...
	fun smsCodeLogin(phone: String?, smsCode: String?, jpushRID: String?, appType: Int?, appChannel: String?, appVersion: String?) {
		mDisposable = AppClient.getAPIService().smsCodeLogin(phone, smsCode, jpushRID, appType!!, appChannel, appVersion)
