...
/**
 * Created with IntelliJ IDEA. packageName  : com.bidekeji.util Company      : 彼得科技 User         :
 * zj Date         : 16/12/3 Time         : 下午1:17 Description  :
 */
public class TimeStampMD5andKL {
	 ...
	 * 加密接口
	 *
	 * @param appLocalStartTime app相对于服务器时间的时间
	 * @param serverStartTime 服务器时间
	 */
	public static String JiamiByMiYue(Long appLocalStartTime, Long serverStartTime) {
		...
		String now = new String(
			String.valueOf(System.currentTimeMillis() - appLocalStartTime + serverStartTime));
