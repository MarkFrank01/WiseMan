 ...
 * @Description :
 */
public class GetBackNumAndDataEvent {
    private int type;
    private List<Integer> contentList;
    private List<CardBean> cardBeanList;

    public GetBackNumAndDataEvent(int type, List<Integer> contentList) {
        this.type = type;
        this.contentList = contentList;
    }

    public GetBackNumAndDataEvent(int type, List<Integer> contentList, List<CardBean> cardBeanList){
        this.type = type;
        this.contentList = contentList;
