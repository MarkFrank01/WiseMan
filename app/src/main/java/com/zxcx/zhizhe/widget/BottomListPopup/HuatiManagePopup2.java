 ...
 * @Description :
 */
public class HuatiManagePopup2 extends BottomPopupView{
    ...
    public HuatiManagePopup2(@NonNull Context context, int type, boolean isFix, int checkedPosition, OnSelectListener selectListener) {
        super(context);
        this.type = type;
        this.isFix = isFix;
    ...
    public HuatiManagePopup2(@NonNull Context context) {
        super(context);
    }

    @Override
    protected int getImplLayoutId() {
        return R.layout.circle_huati_bottom1;
    }
