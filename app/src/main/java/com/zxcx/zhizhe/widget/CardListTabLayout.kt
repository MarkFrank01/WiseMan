...
class CardListTabLayout : TabLayout {
    ...
    class CardListTabLayoutOnPageChangeListener(tabLayout: CardListTabLayout) : ViewPager.OnPageChangeListener {
        ...
        private var mNormalTextSize = mTabLayoutRef.get()?.mNormalTextSize?:ScreenUtils.dip2px(15f)
        private var mSelectTextSize = mTabLayoutRef.get()?.mSelectTextSize?:ScreenUtils.dip2px(22f)
