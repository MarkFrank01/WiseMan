...
public class CustomDatePicker {
	...
	private void initView() {
		...
		tv_cancle = (TextView) datePickerDialog.findViewById(R.id.tv_dialog_cancel);
		tv_select = (TextView) datePickerDialog.findViewById(R.id.tv_dialog_confirm);
		...
		TextPaint tp = tv_cancle.getPaint();
		tp.setFakeBoldText(true);
		tp = tv_select.getPaint();
		tp.setFakeBoldText(true);
	}
