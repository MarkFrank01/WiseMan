 ...
 * font, and its own size.<br/> code is heavily based on this StackOverflow thread:
 * http://stackoverflow.com/questions/16017165/auto-fit-textview-for-android/21851239#21851239 <br/>
 * It should work fine with most Android versions, but might have some issues on Android 3.1 - 4.04,
 * as setTextSize will only work for the first time. <br/> More info here:
 * https://code.google.com/p/android/issues/detail?id=22493 and here in case you wish to fix it:
		...
		_sizeTester = new SizeTester() {
			...
			public int onTestSize(final int suggestedSize, final RectF availableSpace) {
				...
				if (transformationMethod != null) {
					text = transformationMethod
						.getTransformation(getText(), AutoResizeTextView.this)
						.toString();
				} else {
...
//    });
	...
	private interface SizeTester {
		 ...
		 * @return an integer < 0 if after applying {@code suggestedSize} to text, it takes less
		 * space than {@code availableSpace}, > 0 otherwise
		 */
