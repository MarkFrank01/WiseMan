...
import com.zxcx.zhizhe.widget.gridview.GridItemLongClickListener;
import com.zxcx.zhizhe.widget.gridview.ViewPagerAdapter;
 ...
 * @Description :
 */
public class TJGridViewPager extends RelativeLayout {
    ...
    public TJGridViewPager(Context context) {
        super(context);
        mContext = context;
        initView();
    }

    public TJGridViewPager(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        initView();
    }

    public TJGridViewPager(Context context, AttributeSet attrs, int defStyleAttr) {
     ...
     * @return
     */
    public TJGridViewPager init(List<ContentBean> list) {
        mData = list;
        //总的页数=总数/每页数量，并取整
        ...
        for (int i = 0; i < pageCount; i++) {
            //每个页面都是inflate出一个新实例
            GridView gridView = (GridView) inflater.inflate(R.layout.gridview1, mPager, false);
            gridView.setAdapter(new TJGridViewAdapter(mContext, mData, i, pageSize));
            ...
            gridView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
                ...
                public boolean onItemLongClick(AdapterView<?> parent, View view, int pos, long id) {
                    if (gridItemLongClickListener == null) return false;
                        ...
                        int position = pos + curIndex * pageSize;
                        gridItemLongClickListener.click(pos, position, mData.get(position).getTitle());
                        return true;
                    }
                }
            });
     ...
     * @return
     */
    public TJGridViewPager setGridItemClickListener(GridItemClickListener listener) {
     ...
     * @return
     */
    public TJGridViewPager setGridItemLongClickListener(GridItemLongClickListener listener) {
    ...
    public TJGridViewPager setPageSize(int pageSize) {
