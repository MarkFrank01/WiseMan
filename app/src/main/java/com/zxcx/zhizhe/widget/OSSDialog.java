...
public class OSSDialog extends BaseDialog implements IGetPresenter<OSSTokenBean>{
    ...
    private void uploadFileToOSS(String filePath) {
        ...
        OSSCredentialProvider credentialProvider = new OSSStsTokenCredentialProvider(mOSSTokenBean.getAccessKeyId(), mOSSTokenBean.getAccessKeySecret(), mOSSTokenBean.getSecurityToken());
        OSS oss = new OSSClient(getActivity().getApplicationContext(), endpoint, credentialProvider);
        // 构造上传请求
