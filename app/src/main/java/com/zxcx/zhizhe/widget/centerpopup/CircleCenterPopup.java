 ...
 * @Description :
 */
public class CircleCenterPopup extends CenterPopupView{

    private String textContent;
    private OnSelectListener mSelectListener;

    public CircleCenterPopup(@NonNull Context context) {
        super(context);
    }

    public CircleCenterPopup(@NonNull Context context, OnSelectListener selectListener) {
        super(context);
    ...
    protected int getImplLayoutId() {
        return R.layout.circle_center_popup;
    }
