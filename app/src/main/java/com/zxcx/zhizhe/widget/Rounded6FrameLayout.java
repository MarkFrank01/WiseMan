...
public class Rounded6FrameLayout extends FrameLayout {

    int radius = ScreenUtils.dip2px(6);
    Path path = new Path();
    RectF mRectF = new RectF();
    Paint roundPaint = new Paint();
    private final Paint imagePaint;

    public Rounded6FrameLayout(@NonNull Context context) {
        super(context);
    }

    public Rounded6FrameLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public Rounded6FrameLayout(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
