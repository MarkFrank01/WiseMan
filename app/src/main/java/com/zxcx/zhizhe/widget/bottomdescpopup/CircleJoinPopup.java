 ...
 * @Description :
 */
public class CircleJoinPopup extends BottomPopupView{
    ...
    public CircleJoinPopup(@NonNull Context context) {
        super(context);
    }


    public CircleJoinPopup(@NonNull Context context, String desc_content1, String desc_content2, String desc_content3, String desc_content4, int checkPosition, OnSelectListener selectListener) {
        super(context);
    ...
    public CircleJoinPopup(@NonNull Context context, String desc_content1, String desc_content2, String desc_content3, String desc_content4, String bottom_text, int checkPosition, OnSelectListener selectListener) {
        super(context);
        this.desc_content1 = desc_content1;
        this.desc_content2 = desc_content2;
        this.desc_content3 = desc_content3;
    ...
    protected int getImplLayoutId() {
        return R.layout.circle_popup_join;
    }
