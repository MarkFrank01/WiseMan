 ...
 * @Description :
 */
public class CircleBottomGBPopup extends BottomPopupView {
    ...
    public CircleBottomGBPopup(@NonNull Context context) {
        super(context);
    }

    public CircleBottomGBPopup(@NonNull Context context, String desc_content1, String desc_content2, int checkPosition, OnSelectListener selectListener) {
        super(context);
    ...
    protected int getImplLayoutId() {
        return R.layout.circle_popup_bottom_desc_gb;
    }
